...
import com.project.social_network.dto.JoinMessage;
import com.project.social_network.dto.PlayerMessage;
import com.project.social_network.dto.TicTacToeMessage;
import com.project.social_network.enums.GameState;
import com.project.social_network.manager.TicTacToeManager;
import com.project.social_network.model.TicTacToe;
import org.springframework.web.socket.messaging.SessionDisconnectEvent;

@Controller
public class MessageTicTacToeController {
     ...
     * @return the current state of the game, or an error message if the player was
     *         unable to join
     */
    ...
    public Object joinGame(@Payload JoinMessage message, SimpMessageHeaderAccessor headerAccessor) {
        ...
        if (game == null) {
            ...
            errorMessage.setContent(
                    "Não foi possível entrar no jogo. Talvez o jogo já esteja cheio ou ocorreu um erro interno.");
            return errorMessage;
        }
     ...
     * If the player is successfully removed from the game, a message is sent to
     * subscribers
     ...
     * If the move is valid, the game state is updated and sent to all subscribers
     * of the game's topic.
     * If the game is over, a message is sent indicating the result of the game.
     *
     * @param message the message from the client containing the player's name, game
     *                ID, and move
     */
