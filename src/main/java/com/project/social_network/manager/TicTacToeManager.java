package com.project.social_network.manager;
...
public class TicTacToeManager {
    ...
    /**
     * Map of players waiting to join a Tic-Tac-Toe game, with the player's name as
     * the key.
     */
    ...
    /**
     * Attempts to add a player to an existing Tic-Tac-Toe game, or creates a new
     * game if no open games are available.
     *
    ...
    public synchronized TicTacToe joinGame(String player) {
        if (games.values().stream().anyMatch(game -> game.getPlayer1().equals(player)
            ...
            return games.values().stream()
                    .filter(game -> game.getPlayer1().equals(player) || game.getPlayer2().equals(player)).findFirst()
                    .get();
        }
    ...
    /**
     * Removes a player from their Tic-Tac-Toe game. If the player was the only
     * player in the game,
     * the game is removed.
     *
     * @param player the name of the player
     ...
     * @return the Tic-Tac-Toe game with the given game ID, or null if no such game
     *         exists
     */
     ...
     *
     * @param player the name of the player
     * @return the Tic-Tac-Toe game the given player is in, or null if the player is
     *         not in a game
     */
